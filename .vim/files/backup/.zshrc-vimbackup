...
alias gd="git diff"
alias gs="git status -st 2>/dev/null"

function gclone() { git clone https://github.com/peterm-m/"$*".git }
function gcommit() { git commit -m "$*" }

# More suitable for .zshenv
export USER='pedromar'
export EMAIL='pedromar@student.42madrid.com' 
